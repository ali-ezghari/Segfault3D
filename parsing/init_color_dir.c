...
int	parse_line(char *line, t_argv_check *argvs, t_map_info *data)
{
	if (ft_strncmp(line, "NO ", 3) == 0)
		return (argvs[0].checked = 1, init_directions(line, data->dir.NO, data), 0);
	if (ft_strncmp(line, "SO ", 3) == 0)
		return (argvs[1].checked = 1, init_directions(line, data->dir.SO, data), 0);
	if (ft_strncmp(line, "WE ", 3) == 0)
		return (argvs[2].checked = 1, init_directions(line, data->dir.WE, data), 0);
	if (ft_strncmp(line, "EA ", 3) == 0)
		return (argvs[3].checked = 1, init_directions(line, data->dir.EA, data), 0);
	if (ft_strncmp(line, "F ", 2) == 0)
		return (argvs[4].checked = 1, init_color(line, &data->color.floor, data), 0);
	if (ft_strncmp(line, "C ", 2) == 0)
		return (argvs[5].checked = 1, init_color(line, &data->color.ceil, data), 0);
